...
Vagrant.configure("2") do |config|
    ...
    config.vm.define "gateway" do |tcp2|
      tcp2.vm.hostname = "gateway"
    ...
    config.vm.define "trader1" do |tcp5|
      tcp5.vm.hostname = "trader1"
    ...
    config.vm.define "trader2" do |tcp6|
            tcp6.vm.hostname = "trader2"
    ...
    config.vm.define "trader3" do |tcp7|
            tcp7.vm.hostname = "trader3"
